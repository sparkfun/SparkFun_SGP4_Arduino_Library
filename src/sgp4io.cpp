    ...
    elsetrec &satrec)
{
  ...
  **/
  ...
  memcpy(tempstr, &longstr1[2], 5);
  tempstr[5] = '\0';
  satrec.satnum = atol(tempstr);
  // classification = longstr1[7];
  // memcpy( intldesg, &longstr1[8] , 10); intldesg[10] = '\0';
  memcpy(tempstr, &longstr1[18], 2);
  tempstr[2] = '\0';
  satrec.epochyr = atoi(tempstr);
  memcpy(tempstr, &longstr1[20], 12);
  tempstr[12] = '\0';
  satrec.epochdays = atof(tempstr);
  memcpy(tempstr, &longstr1[32], 11);
  tempstr[11] = '\0';
  satrec.ndot = atof(tempstr);
  memcpy(tempstr, &longstr1[43], 7);
  tempstr[7] = '\0';
  satrec.nddot = atof(tempstr);
  memcpy(tempstr, &longstr1[50], 2);
  tempstr[2] = '\0';
  nexp = atoi(tempstr);
  memcpy(tempstr, &longstr1[52], 7);
  tempstr[7] = '\0';
  satrec.bstar = atof(tempstr);
  memcpy(tempstr, &longstr1[59], 2);
  tempstr[2] = '\0';
  ibexp = atoi(tempstr);
  // memcpy( tempstr, &longstr1[61] , 2); tempstr[2] = '\0'; numb = atoi(tempstr);
  // memcpy( tempstr, &longstr1[63] , 6); tempstr[6] = '\0'; elnum = atol(tempstr);

  memcpy(tempstr, &longstr2[2], 5);
  tempstr[5] = '\0';
  satrec.satnum = atol(tempstr);
  memcpy(tempstr, &longstr2[7], 9);
  tempstr[9] = '\0';
  satrec.inclo = atof(tempstr);
  memcpy(tempstr, &longstr2[16], 9);
  tempstr[9] = '\0';
  satrec.nodeo = atof(tempstr);
  memcpy(tempstr, &longstr2[25], 8);
  tempstr[8] = '\0';
  satrec.ecco = atof(tempstr);
  memcpy(tempstr, &longstr2[33], 9);
  tempstr[9] = '\0';
  satrec.argpo = atof(tempstr);
  memcpy(tempstr, &longstr2[42], 9);
  tempstr[9] = '\0';
  satrec.mo = atof(tempstr);
  memcpy(tempstr, &longstr2[51], 11);
  tempstr[10] = '\0';
  satrec.no = atof(tempstr);
